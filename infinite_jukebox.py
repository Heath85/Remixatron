...
SOUND_END = pygame.locals.USEREVENT + 2
#pygame.mixer.Channel.set_endevent(SOUND_END)
...
if __name__ == "__main__":
    ...
    # pygame's eventoo handling functions won't work unless the
    ...
    for v in jukebox.play_vector[1:]:
        ...
        window.addstr(20,0,str(beat_to_play) + ' ' * 10)
        
        
        display_playback_progress(v)

    print("playback finished unexpectedly")
